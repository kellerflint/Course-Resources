...
### [[SQL Analytics M2 - Installing MySQL Workbench and MariaDB|Installing MySQL Workbench and MariaDB]] (17 min vid)
...
### [[SQL Analytics M2 - MySQL Workbench Basics|MySQL Workbench Basics]] (8 min vid)

### [[SQL Analytics M2 - How to Complete SQL Assignments|How to Complete SQL Assignments]] (3 min)

### [[SQL Analytics - Northwind Database|Northwind Database]] (2 min vid)

### [[SQL Analytics M2 - SELECT Statements|SELECT Statements]] (8 min vid)
...
### [[SQL Analytics M2 - Math on Columns|Math on Columns]] (4 min vid)
...
### [[SQL Analytics M2 - Column Aliasing|Column Aliasing]] (3 min vid)
...
### [[SQL Analytics M2 - WHERE Clause|WHERE Clause]] (30 min vid)
...
### [[SQL Analytics M2 - ORDER BY, LIMIT, and Query Structure|ORDER BY, LIMIT, and Query Structure]] (11 min vid)
